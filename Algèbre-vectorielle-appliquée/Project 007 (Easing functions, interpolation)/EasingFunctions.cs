...
public class EasingFunctions : MonoBehaviour
{
    ...
    [Header("TYPE")]
    [SerializeField] InterpolationType interpolationType = InterpolationType.Linear;
    [SerializeField] MethodType methodType = MethodType.Loop;
    [Space(10)]
    ...
    void UpdateInterpolation(InterpolationType interpolationType, MethodType methodType)
    {
        Vector3 position;
        ...
        spriteColor = Color.Lerp(Color.white, targetColor, currentTime);
    ...
    // Ease In (Vector 3)
    Vector3 EaseIn(Vector3 start, Vector3 end, float t)
    {
