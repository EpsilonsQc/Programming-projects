...
int main()
{
	...
	cout << "Enter a phone number (digits 2 through 9) " << "in the form: xxx-xxxx" << endl;
...
void wordGenerator(const int* const n)
{
	...
	if (!outFile) 
	{
		cerr << "\"phone.dat\" could not be opened." << endl;
		exit(EXIT_FAILURE);
	}
...
{
	cout << "======================================" << endl;
	cout << ".:: TELEPHONE-NUMBER WORD GENERATOR ::." << endl;
	cout << "======================================" << endl << endl;
}
